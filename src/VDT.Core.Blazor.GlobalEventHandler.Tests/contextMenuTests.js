describe('contextmenu', function () {
    it('event handler gets registered', async function () {
        ...
        expect(typeof _helpers.window.eventListeners['contextmenu']).toEqual('function');
    });
    ...
    it('event handler gets unregistered', async function () {
        ...
        expect(_helpers.window.eventListeners['contextmenu']).toBeUndefined();
    });
    ...
    it('event invokes handler', async function () {
        ...
        _helpers.window.eventListeners['contextmenu'](new MouseEvent(null, {
            altKey: true,
            button: 0,
            buttons: 0,
            clientX: 10,
        ...
        expect(_helpers.dotNetObjectReference.invocations[0].handlerReference).toEqual('InvokeContextMenu');
