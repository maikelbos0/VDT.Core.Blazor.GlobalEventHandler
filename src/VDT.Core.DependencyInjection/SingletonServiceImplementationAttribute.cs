...
namespace VDT.Core.DependencyInjection {
    /// <summary>
    /// Marks a service implementation to be registered as a singleton service when calling <see cref="ServiceCollectionExtensions.AddAttributeServices(IServiceCollection, Assembly)"/>
