...
namespace VDT.Core.DependencyInjection {
    /// <summary>
    /// Marks a service implementation to be registered as a transient service when calling <see cref="ServiceCollectionExtensions.AddAttributeServices(IServiceCollection, Assembly)"/>
    ...
    /// </summary>
    public sealed class TransientServiceImplementationAttribute : ServiceAttribute {
